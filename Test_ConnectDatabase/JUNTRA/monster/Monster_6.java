...
public class Monster_6 extends Monster{
	
	public Monster_6(Map map,Hero hero) {
		super(map,hero);
		
		
		powerliving=1000;
		powerattack=(int)(20+Math.random()*30);
		deform=(int)(15+Math.random()*120);
		speed=(int)(300+Math.random()*500);
		
		x=20;y=300;w=80;h=80;

		file="governorMonster/Hmon6.png";
