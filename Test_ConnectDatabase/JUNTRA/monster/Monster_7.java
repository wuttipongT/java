...
public class Monster_7 extends Monster{
	
	public Monster_7(Map map,Hero hero) {
		super(map,hero);
		
		
		powerliving=1000;
		powerattack=(int)(20+Math.random()*30);
		deform=(int)(15+Math.random()*20);
		speed=(int)(300+Math.random()*500);
		
		x=20;y=300;w=96;h=96;

		file="governorMonster/Hmon7.png";
