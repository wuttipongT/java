...
public class MonsterLackey_4 extends Monster{
	
	public MonsterLackey_4(Map map,Hero hero) {
		super(map,hero);
		
		powerliving=500;
		powerattack=(int)(15+Math.random()*20);
		deform=(int)(5+Math.random()*10);
		speed=(int)(400+Math.random()*500);
