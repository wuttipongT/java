...
public class Map2 extends Map{
	...
	int setLo;
	int way=0;
	public Map2(Main_JuntraGame frame,Hero hero) {
		...
		//n1.setBounds(100, 0, 300, 260);
		//n2.setBounds(0, 50, 100, 330);
		//add(n1);add(n2);
		createitem.run();
	}
	protected void paintComponent(Graphics g) {
		//super.paintComponents(g);
		image=tk.getImage("images/Map2.jpg");
	...
	public void keyPressed(KeyEvent e){
		...
		if(monster.size()==0){//เอาไว้ขึ้นคำพูดเมื่อชน
			...
			mainGame.createMapFight(2,hero);
		}
