...
public class ITem_powerliving extends ITem{

	public ITem_powerliving(Map map, Hero hero, int ranX) {
		super(map, hero, ranX);
		randomnameitem=(int)(1+Math.random()*7);
		icon=new ImageIcon("items/powerliving"+randomnameitem+".png");
