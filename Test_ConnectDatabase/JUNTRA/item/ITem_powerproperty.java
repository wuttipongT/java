...
public class ITem_powerproperty extends ITem{

	public ITem_powerproperty(Map map, Hero hero, int ranX) {
		super(map, hero, ranX);
		randomnameitem=(int)(1+Math.random()*8);
		icon=new ImageIcon("items/powerproperty"+randomnameitem+".png");
