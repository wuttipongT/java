...
public class Node extends JFrame implements ActionListener,MouseListener{
	...
	private void initComponent(){
		...
		clear.setBounds(620, 220, 100, 30);
		...
		p.add(outName);
		p.add(output); 
		p.setBorder(new TitledBorder(new LineBorder(Color.black),"Information! : a b c Exam bcc!"));
	...
	private void myFrame(){
		setSize(850,400);
		setVisible(true);
		setTitle("Ex 13 Turing Machine! Exam bcc,abbccc,aabbbcccc,aaabbbbccccc,... ");
