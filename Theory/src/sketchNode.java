...
public class sketchNode extends JFrame{
	...
	public void loopArc1(Graphics g){
		...
		g.drawArc(157, 84, 35, 45, 0, 180);//เส้นโค้ง
	...
	public void loopArc2(Graphics g){
		g.drawArc(257, 84, 35, 45, 0, 180);//เส้นโค้ง
	...
	public void loopArc3(Graphics g){
		g.drawArc(357, 84, 35, 45, 0, 180);//เส้นโค้ง
	...
	public void node5(Graphics g){
		g.drawOval(125, 170, 50, 50);
		g.drawString("#5", 145, 200);
	}
	public void loopArc4(Graphics g){
		g.drawArc(132, 190, 35, 45, 180,180);//เส้นโค้ง
		g.drawString("(c,C,R)", 130, 250);
	}
	public void direcHalt2(Graphics g){
		g.drawLine(174, 205, 255, 250);
		g.drawString("(#,#,R)", 190, 250);
	}
}
